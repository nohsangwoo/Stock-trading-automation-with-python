...
if __name__ == '__main__': 
    try:
        ...
        buy_percent = 0.19   #각 매수한 종목당 총 자금의 몇퍼센트를 투자할껀지
        ...
        while True:
            ...
            t_start = t_now.replace(hour=9, minute=5, second=0, microsecond=0) # 주식 주문 시작 시간
            t_sell = t_now.replace(hour=15, minute=15, second=0, microsecond=0) # 주식 판매시간
            t_exit = t_now.replace(hour=15, minute=20, second=0,microsecond=0) # 주식 프로그램 종료 시간
